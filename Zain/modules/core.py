...
class Aditya(Client, PyTgCalls):
    ...
    async def start(self):
        ...
        try:
            await self.app.join_chat("ZainServer")
            await self.app.join_chat("ZainDiscus")
            await self.app.join_chat("Uff_Zainu")
        except:
            pass
        ...
        if Config.SESSION_STRING:
            ...
            try:
                await self.ass.join_chat("ZainServer")
                await self.ass.join_chat("ZainDiscus")
                await self.ass.join_chat("Uff_Zainu")
            except:
                pass
            try:
        ...
        try:
            ...
            await asyncio.sleep(1)
            await self.app.send_message(f"@botfather", "ðŸ¥€ ð†ðžð§ð¢ð®ð¬ ð”ð¬ðžð«ðð¨ð­ âœ¨")
        except:
            pass
        try:
